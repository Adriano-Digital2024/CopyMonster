...
--
-- This update switches every active agent to deepseek/deepseek-chat, which the
-- llm-router resolves via the DeepSeek OpenAI-compatible endpoint using
-- DEEPSEEK_API_KEY. Per-agent model_id remains the source of truth (the admin
-- /providers panel intentionally only applies to agents without model_id).
--
